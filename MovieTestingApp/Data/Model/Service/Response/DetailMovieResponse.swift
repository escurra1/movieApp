...
class DetailMovieResponse: NSObject, NSCoding {
    var adult: Bool?
    ...
    func toDictionary() -> [String:Any]
    {
        ...
        if genres != nil {
            ...
            guard let genreResponse = genres else {
                return [String:Any]()
            }
            for genresElement in genreResponse {
        ...
        if productionCompanies != nil {
            var dictionaryElements = [[String:Any]]()
            guard let productionCompaniesResponse = productionCompanies else {
                return [String:Any]()
            }
            for productionCompaniesElement in productionCompaniesResponse {
        ...
        if productionCountries != nil {
            var dictionaryElements = [[String:Any]]()
            guard let productionCountriesResponse = productionCountries else {
                return [String:Any]()
            }
            for productionCountriesElement in productionCountriesResponse {
        ...
        if spokenLanguages != nil {
            var dictionaryElements = [[String:Any]]()
            guard let spokenLanguagesResponse = spokenLanguages else {
                return [String:Any]()
            }
            for spokenLanguagesElement in spokenLanguagesResponse {
